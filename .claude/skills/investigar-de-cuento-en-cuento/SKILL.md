---
name: investigar-de-cuento-en-cuento
description: Completar y mantener los datos de la serie De Cuento en Cuento (episodios, protagonistas, agrupaciones, territorios, locaciones, objetos, La Posta, cápsulas, audios, transcripciones) usando únicamente los documentos del proyecto (propuesta vigente, ruta.py, investigación madre, cartas de compromiso) y fuentes públicas citadas en ellos, sin datos personales sensibles, en JSON conforme a data/schemas/episode.schema.json.
---

# Investigar De Cuento en Cuento

Referencia: `docs/DE_CUENTO_EN_CUENTO.md`.
...
3. Propuesta de difusión vigente (`De Cuento en Cuento.docx`): estructura, dispositivo, productos comprometidos, accesibilidad.
...
- Fichas de artistas y compañías en sus colecciones (usar las skills correspondientes), con `series: ["de-cuento-en-cuento"]`.
...
- Las discrepancias entre brief y documentos se anotan en `docs/DE_CUENTO_EN_CUENTO.md` §9, no se resuelven inventando.
