/** Textos de interfaz en español de Chile. Tono: cercano, preciso, sin solemnidad. */
...
export const t = {
  ...
  empty: {
    ...
    generic: "Aún no tenemos este dato.",
    know: "¿Lo conoces?",
    propose: "Proponer",
  },

  verification: {
    pendiente: "Ficha en verificación",
    verificado: "Ficha verificada",
    requiere_actualizacion: "Ficha en revisión",
    rechazado: "Ficha rechazada",
    pendingHelp: "Esta ficha no está publicada. Sus datos se están contrastando con fuentes y se validarán con la persona o agrupación antes de publicarse.",
    sources: "Fuentes",
    consulted: "consultada el",
    score: "confianza",
  },

  contact: {
    none: "Aún no tenemos un contacto público de esta ficha.",
    yours: "¿Es tu ficha? Pide una corrección o agrega tu contacto profesional.",
    correct: "Corregir o retirar información",
  },

  explore: {
    title: "Sigue explorando",
    subtitle: "Más de la misma provincia",
  },
} as const;
