...
export const metadata: Metadata = pageMetadata({
  title: "Protagonistas · De Cuento en Cuento",
  description: "Las siete personas y agrupaciones de las artes escénicas familiares que protagonizan la primera temporada de De Cuento en Cuento en la Región de Valparaíso.",
  path: "/de-cuento-en-cuento/protagonistas",
});
  ...
  return (
    <div className="wrap">
      <PageHeader
        ...
        crumbs={[{ name: "De Cuento en Cuento", href: "/de-cuento-en-cuento" }, { name: "Protagonistas", href: "/de-cuento-en-cuento/protagonistas" }]}
      />
      {visible.length ? (
        ...
        <EmptyState text="Los perfiles de las siete personas protagonistas se publican después de que cada una valide su ficha." proposeLabel="Ver la serie" proposeHref="/de-cuento-en-cuento" />
      )}
    </div>
  );
}
